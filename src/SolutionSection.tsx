      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-lg text-gray-700 leading-relaxed">
          <p className="mb-6">
            ...
            apresentamos o <strong className="text-blue-700">Elo</strong>. Mais que um aplicativo, o Elo é a ponte digital 
            que une família e escola de forma simples, segura e eficiente.
          </p>
          <p>
            Criamos um <strong className="text-blue-700">elo</strong> de comunicação e confiança, permitindo que você 
